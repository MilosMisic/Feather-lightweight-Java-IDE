...
public abstract class AbstractCompletionProvider
     ...
     * parent <tt>CompletionProvider</tt>, if there is one.
     *
     * @see #addCompletion(Completion)
     * @see #addCompletions(List)
     * @see #removeCompletion(Completion)
     ...
     * @return A list of {@link Completion}s, or <code>null</code> if there are
     * no matching <tt>Completion</tt>s.
     */
    ...
    /**
     * A comparator that compares the input text of a {@link Completion} against
     * a String lexicographically, ignoring case.
     */
